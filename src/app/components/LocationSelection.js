...
import { FaMapMarkedAlt, faMapMarketAlt } from "react-icons/fa";

const locations = [
  "Main street 123 , United States ",
  "Business Avenue 456, Canada",
  "Park Road 89, United Kingdom",
];
      ...
      <div className="relative flex-1">
        ...
        >
          {locations.map((location,index)=>{
            ...
            key={index} className="cursor-pointer py-4 xl:pl-10 hover:bg-gray-50 
            text-[13px] uppercase ">{location}</div>
          })}
        </Menu.Items>
      </div>
    </Menu>
